...
beforeEach(function () {
    $this->person = $this->getApiMock(Person::class);
});
...
test('get_person_by_reg_id', function () {
    ...
    $this->assertEquals($expectedArray, $this->person->getByRegID('ADA12DA10F7649B2A8861B14633F0A0A'));
});
...
test('get_person_by_uw_net_id', function () {
    ...
    $this->assertEquals($expectedArray, $this->person->getByNetID('testuser1'));
});
...
test('find_person_by_first_name', function () {
    ...
    $this->assertEquals($expectedArray, $this->person->findByName(['first_name' => 'Test W']));
});
...
test('find_person_by_last_name', function () {
    ...
    $this->assertEquals($expectedArray, $this->person->findByName(['last_name' => 'User']));
});
...
test('find_person_by_first_and_last_name', function () {
    ...
    $this->assertEquals($expectedArray, $this->person->findByName(['first_name' => 'Test W', 'last_name' => 'User']));
});
...
test('find_person_by_first_and_last_name_with_wildcard', function () {
    ...
    $this->assertEquals($expectedArray, $this->person->findByName(['first_name' => 'Test*', 'last_name' => 'User']));
});
...
test('find_person_by_uw_net_id_string', function () {
    ...
    $this->assertEquals($expectedArray, $this->person->findByNetID('testuser1'));
});
...
test('find_person_by_uw_reg_id', function () {
    ...
    $this->assertEquals($expectedArray, $this->person->findByRegID('ADA12DA10F7649B2A8861B14633F0A0A'));
});
...
test('find_person_by_uw_employee_id', function () {
    ...
    $this->assertEquals($expectedArray, $this->person->findByEmployeeID('123456789'));
});
...
test('find_person_by_uw_student_number', function () {
    ...
    $this->assertEquals($expectedArray, $this->person->findByStudentNumber('1234567'));
});
...
test('find_person_by_multiple_ids', function () {
    ...
    $this->assertEquals($expectedArray, $this->person->findByNetID(['testuser1', 'testuser2']));
});
